  ...
  return (
    ...
    <a href="#">
      <div className="relative flex items-end overflow-hidden rounded-xl">
        <img src="https://res.cloudinary.com/walmart-labs/image/upload/c_pad,h_500,w_500,q_auto:best/v1710186854498/gr/images/product-images/img_large/00000007500234L.jpg" alt="lorem ipsum" />
        <div className="flex items-center space-x-1.5 rounded-lg bg-emerald-500 px-4 py-1.5 text-white duration-100 hover:bg-text-emerald-500-600">
